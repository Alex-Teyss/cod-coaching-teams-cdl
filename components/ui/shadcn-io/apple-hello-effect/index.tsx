...
// AppleHelloEffect displays "Bonjour"
const AppleHelloBonjourEffect = AppleHelloEffect;
// Alias for backward compatibility
const AppleHelloVietnameseEffect = AppleHelloEffect;

export { AppleHelloEnglishEffect, AppleHelloVietnameseEffect, AppleHelloEffect, AppleHelloBonjourEffect };
